...
import { Search, Calendar, AlertTriangle, Filter } from "lucide-react";
import useAuthStore from "@/store/authStore";
import { getUserComplaints } from "@/hooks/complaints";
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-amber-100 text-sm mt-0.5">
              {filteredComplaints.length} assigned {filteredComplaints.length === 1 ? "complaint" : "complaints"}
            </p>
          </div>
        </div>
      </div>
                  ...
                  <td colSpan={8} className="py-12">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 font-medium">
                        {search || statusFilter !== "All" ? "No complaints match your filters" : "No assigned complaints"}
                      </p>
                      <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
                        {search || statusFilter !== "All" ? "Try adjusting your search or filters" : "You have not been assigned to any complaints yet"}
                      </p>
                    </div>
                  </td>
                </tr>
