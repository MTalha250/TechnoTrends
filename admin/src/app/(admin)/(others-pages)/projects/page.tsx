...
import { Plus, Search, Calendar, Image as ImageIcon, FolderOpen, Filter } from "lucide-react";
        ...
        <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          {canCreate && (
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-blue-600 rounded-xl hover:bg-blue-50 transition-colors font-semibold shadow-lg shadow-blue-900/20"
            >
                  ...
                  <td colSpan={8} className="py-12">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
                        {search || statusFilter !== "All" ? "Try adjusting your search or filters" : "Create a new project to get started"}
                      </p>
                    </div>
                  </td>
                </tr>
