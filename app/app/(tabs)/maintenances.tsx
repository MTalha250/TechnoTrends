...
const MaintenanceTableHeader = ({ isCompact }: { isCompact: boolean }) => {
  return (
    ...
    >
      ...
      <Text
        className={`font-bold px-3 mx-1 text-gray-800 whitespace-nowrap ${
...
const MaintenanceTableRow = ({
  ...
  const getNextUpcomingDate = (serviceDates: ServiceDate[]) => {
  ...
  return (
    ...
    >
      ...
      <View
        className={`${isCompact ? "w-36" : "w-40"} px-3 h-full py-2 ${
      ...
      <View
        className={`${
          isCompact ? "w-36" : "w-40"
        } px-3 py-2 rounded-lg mx-1 h-full border ${paymentInfo.color}`}
      >
        <Text
          numberOfLines={1}
      ...
      <View className="w-40 px-3">
        ...
        >
          ...
          >
            {(() => {
              const nextDate = getNextUpcomingDate(item.serviceDates);
              return `Due: ${
                nextDate ? formatDate(nextDate as any) : "No upcoming"
              }`;
            })()}
          </Text>
        </View>
            ...
            <View className="flex-row justify-between items-center mb-8">
              <View>
                ...
                <Text className="text-gray-600">
                  {filteredMaintenances.length} maintenances
                </Text>
              </View>
              <View className="flex-row gap-2">
                ...
                <TouchableOpacity
                  onPress={() => router.push("/screens/createMaintenance")}
                  ...
                  <View className="py-12 items-center justify-center bg-white">
                    ...
                    <Text className="text-gray-400 text-sm mt-1 text-center">
                      {searchText || selectedStatus !== "All"
                        ...
                        : "Create a new maintenance to get started"}
                    </Text>
                  </View>
                )}
              </ScrollView>
